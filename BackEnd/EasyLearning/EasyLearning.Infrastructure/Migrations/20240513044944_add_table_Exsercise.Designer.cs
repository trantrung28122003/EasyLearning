...
namespace EasyLearning.Infrastructure.Migrations
{
    ...
    [Migration("20240513044944_add_table_Exsercise")]
    partial class add_table_Exsercise
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyLearing.Infrastructure.Data.Entities.TrainingPart", b =>
                {
                    ...
                    b.Property<string>("ImageUrl")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Training_Part_ImageUrl");
            ...
            modelBuilder.Entity("EasyLearning.Infrastructure.Data.Entities.ExerciseQuestion", b =>
                {
                    ...
                    b.Property<string>("CorrectAnswerId")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ExerciseQuestion_CorrectChoiceId");
                    ...
                    b.Property<string>("ExerciseQuestion_TrainingPartId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("ExerciseQuestion_TrainingPartId1");
                    ...
                    b.HasIndex("ExerciseQuestion_TrainingPartId");

                    b.ToTable("ExerciseQuestion");
                });

            modelBuilder.Entity("EasyLearning.Infrastructure.Data.Entities.UserExserciseAnswer", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ExerciseQuestionId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("ExerciseQuestion_Id");
            ...
            modelBuilder.Entity("EasyLearning.Infrastructure.Data.Entities.UserTrainingProgress", b =>
                {
                    ...
                    b.Property<string>("TrainingPartId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("Training_Part_Id");
            ...
            modelBuilder.Entity("EasyLearning.Infrastructure.Data.Entities.ExerciseQuestion", b =>
                {
                    b.HasOne("EasyLearing.Infrastructure.Data.Entities.TrainingPart", "TrainingPart")
                        ...
                        .HasForeignKey("ExerciseQuestion_TrainingPartId");
            ...
            modelBuilder.Entity("EasyLearning.Infrastructure.Data.Entities.UserExserciseAnswer", b =>
                {
                    b.HasOne("EasyLearning.Infrastructure.Data.Entities.ExerciseQuestion", "ExerciseQuestion")
                        .WithMany("UserExserciseAnswers")
            ...
            modelBuilder.Entity("EasyLearning.Infrastructure.Data.Entities.UserTrainingProgress", b =>
                {
                    b.HasOne("EasyLearing.Infrastructure.Data.Entities.TrainingPart", "TrainingPart")
                        .WithMany("UserTrainingProgresss")
            ...
            modelBuilder.Entity("EasyLearning.Infrastructure.Data.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("UserExserciseAnswers");
